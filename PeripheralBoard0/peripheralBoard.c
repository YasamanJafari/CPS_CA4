...
// Place your code here
    ...
    {                           
        ...
        PORTC.0 = temprature & 1;
        PORTC.1 = temprature & 2;
        PORTC.2 = temprature & 4;
        PORTC.3 = temprature & 8;
        PORTC.4 = temprature & 16;
        PORTC.5 = temprature & 32;
        PORTC.6 = temprature & 64;
        PORTC.7 = temprature & 128;
        //put address
        PORTB.0 = ADDRESS_0;
        PORTB.1 = ADDRESS_1;
...
TCNT0=0x16;
    timer ++;
    if(state == CHECK_TEMP && timer > 10)
    { 
        init();
       
        temprature = (read_adc(1)/2);
